                ...
                >
                    <Tabs
                        ...
                        items={[
                            ...
                            {
                                key: 'prompt',
                                label: <><FileTextOutlined /> Prompt 配置</>,
                                children: (
                                    <Card>
                                        <Form.Item
                            ...
                            {
                                key: 'execution',
                                label: <><ThunderboltOutlined /> 执行配置</>,
                                children: (
                                    <Card>
                                        <Form.Item
                            ...
                            {
                                key: 'log',
                                label: <><DeploymentUnitOutlined /> 日志配置</>,
                                children: (
                                    <Card>
                                        <Form.Item
                                            name="log_level"
